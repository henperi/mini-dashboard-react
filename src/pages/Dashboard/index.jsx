  ...
  <Row className="col-11 col-sm-12 main-content">
    ...
    <Column xl={3} lg={3} md={12} sm={12} className="card padding__all--20">
      <div className="calendar col">
        ...
        <span className="text text-light">December</span>

        <Calendar onChange={() => {}} value={new Date()} className="margin__vertical--10" />
      </div>
      <span className="subtitle">Today, 13 September</span>
